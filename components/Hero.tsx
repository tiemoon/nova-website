...
import { ArrowRight, Play, MessageCircle, Sparkles, Zap, Shield } from "lucide-react";
...
const floatingMessages = [
  { id: 1, text: "How can I help you today?", delay: 0, x: "5%", y: "20%" },
  { id: 2, text: "Ticket #2847 created ✓", delay: 1.5, x: "72%", y: "15%" },
  { id: 3, text: "3 new leads qualified!", delay: 3, x: "80%", y: "60%" },
  { id: 4, text: "Response time: 0.3s", delay: 4.5, x: "2%", y: "65%" },
];
  ...
  return (
    <div className="relative w-[500px] h-[500px] flex items-center justify-center">
      ...
      <div className="relative w-40 h-40 float-animation">
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-violet-600 via-blue-600 to-cyan-500 opacity-90 glow-purple" />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <Zap className="w-14 h-14 text-white drop-shadow-lg" fill="white" />
        </div>
        {/* Pulse rings */}
        {[1, 2].map((i) => (
          <div
      ...
      {floatingMessages.map((msg) => (
        <motion.div
          ...
          transition={{
            ...
            delay: msg.delay,
            repeat: Infinity,
            repeatDelay: floatingMessages.length * 1.5,
            ease: "easeInOut",
          }}
          className="absolute hidden lg:flex items-center gap-2 glass-card rounded-2xl px-3 py-2 text-xs text-gray-300 pointer-events-none"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              conversions, <span className="text-white font-medium">24/7 without breaks.</span>
            </motion.p>
